...
void AssetManager::loadSurfaces()
{
	...
	addSurface("goblin_face_1", "assets/images/spritesheets/actors/goblin/body_parts/face/1.png");
	addSurface("goblin_face_2", "assets/images/spritesheets/actors/goblin/body_parts/face/2.png");
	addSurface("goblin_ears_0", "assets/images/spritesheets/actors/goblin/body_parts/ears/0.png");
	addSurface("goblin_ears_1", "assets/images/spritesheets/actors/goblin/body_parts/ears/1.png");
	addSurface("goblin_ears_2", "assets/images/spritesheets/actors/goblin/body_parts/ears/2.png");
	...
	addSurface("human_face_1", "assets/images/spritesheets/actors/human/body_parts/face/1.png");
	addSurface("human_face_2", "assets/images/spritesheets/actors/human/body_parts/face/2.png");
	addSurface("human_hair_0", "assets/images/spritesheets/actors/human/body_parts/hair/0.png");
	addSurface("human_hair_1", "assets/images/spritesheets/actors/human/body_parts/hair/1.png");
	addSurface("human_hair_2", "assets/images/spritesheets/actors/human/body_parts/hair/2.png");
